...
- Editing [docs/getting-started.md](../../../docs/getting-started.md) or [docs/README.md](../../../docs/README.md)
...
Topic depth still belongs in existing `docs/*.md` and agent skills — Getting Started stays a **thin narrative with deep links**. Do not invent new DSL in the guide; copy from shipped examples / schemas.
